...
Download the latest release  at GitHub: "*IPEM Toolbox 1.03*":https://github.com/IPEM/IPEMToolbox/zipball/master.
...
Here, a list of scholarly works done using the IPEM Toolbox can be found. A more complete "list of research done using the IPEM Toolbox":http://scholar.google.be/scholar?q=%22IPEM+Toolbox%22+&btnG=&hl=en&as_sdt=0%2C5 can be found on Google Scholar. Some key papers include:

* "An Auditory Model of the Role of Short-Term Memory in Probe-Tone Ratings":http://www.jstor.org/stable/40285830, Marc Leman, __Music Perception: An Interdisciplinary Journal__ , Vol. 17, No. 4, Tonality Induction (Summer, 2000), p. 481-509
...
* *2016.03.31 - IPEM Toolbox 1.03* - Matlab 6.0, 7.0, 8.0, and Octave -  Windows and UNIX. Published on github and indluded information on using the toolbox on 64bit windows and matlab 8 thanks to Jane Lee.
