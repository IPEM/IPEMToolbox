...
%
% NOTE:
% This is a modified version of IPEMProcessAuditoryModel.m 
% Normally, this is compiled into the Mex interface for the ANI algorithm
% However, due to difficulties with generating mex wrapper code in 
% Matlab 7(MCC 4.0), this was bypassed. Instead, the interface to the ANI
% calculation is now implemented in C (IPEMProcessAuditoryModelSafe.c)
%
% The other functions included here are only for parameter checking, so
% compiling them doesn't provide much benefit.
%
% --Comment by Stefan Tomic (sttomic@ucdavis.edu)
%
%
%
% Usage:
...
%
% Commented out by Stefan Tomic
% IPEMProcessAuditoryModelSafe is now implemented as a mex function
%
% ------------------------------------------------------------------------------
