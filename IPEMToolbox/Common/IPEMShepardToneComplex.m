function outSignal = IPEMShepardToneComplex (varargin)
% Usage:
...
[inToneVector,inDuration,inSampleFreq,inPhaseFlag,indBLevel] = ...
...
for i = 1:12
   if inToneVector(i) ~= 0
      outSignal = outSignal + IPEMShepardTone(theNoteFreqs(i),inDuration,inSampleFreq,inPhaseFlag);
   end
end
